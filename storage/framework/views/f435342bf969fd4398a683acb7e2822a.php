<?php $__env->startSection('title', 'JRMSU SSG E-Voting System — Siocon Campus'); ?>
...
<nav style="background: var(--navy); border-bottom: 2px solid var(--gold);" class="sticky top-0 z-50 shadow-lg">
    <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <img src="<?php echo e(asset('images/SSG.jpg')); ?>" alt="SSG Logo"
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('voter.login')); ?>"
...
<section class="hero py-20 px-6 text-center text-white relative z-10">
    <div class="max-w-3xl mx-auto relative z-10">
        ...
        <div class="fade-up flex justify-center mb-6">
            <img src="<?php echo e(asset('images/SSG.jpg')); ?>"
                 alt="JRMSU SSG Seal"
                 class="seal-ring">
        </div>
        ...
        <div class="fade-up fade-up-d4 flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(route('voter.login')); ?>" class="btn-gold">
                🗳&nbsp; Cast Your Vote
            </a>
...
<section class="py-16 px-6" style="background: var(--gold-muted);">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-8">
            <?php $__currentLoopData = ['President', 'Vice President', 'Secretary', 'Treasurer', 'Auditor', 'P.R.O.', 'Senators']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<footer class="py-10 px-6 text-center" style="background: #0a1628; border-top: 3px solid var(--gold);">
    ...
    <div class="flex justify-center gap-6 mb-6">
        <a href="<?php echo e(route('voter.login')); ?>" class="text-sm hover:underline" style="color: var(--gold);">Voter Login</a>
        <span style="color: rgba(255,255,255,.2);">|</span>
        <a href="<?php echo e(route('admin.login')); ?>" class="text-sm hover:underline" style="color: var(--gold);">Admin Login</a>
    </div>
    <p class="text-xs" style="color: rgba(255,255,255,.3);">
        &copy; <?php echo e(date('Y')); ?> JRMSU SSG E-Voting System. All rights reserved.
    </p>
</footer>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JRMSU E_VOTING SYSTEM\resources\views/welcome.blade.php ENDPATH**/ ?>