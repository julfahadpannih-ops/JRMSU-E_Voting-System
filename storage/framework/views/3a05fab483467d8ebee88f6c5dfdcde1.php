...
<div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 mb-6">
    <h3 class="font-bold text-yellow-800 mb-3 text-sm">⏳ Pending Registrations (<?php echo e($pending->count()); ?>)</h3>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-100" id="voters-table">
            ...
            <tbody class="divide-y divide-gray-50" id="voters-tbody">
                ...
                <tr class="hover:bg-gray-50 transition-colors" id="voter-row-<?php echo e($voter->id); ?>">
                    <td class="px-6 py-4 text-xs font-mono text-gray-500"><?php echo e($voter->student_id); ?></td>
                    <td class="px-6 py-4 font-medium text-sm"><?php echo e($voter->name); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($voter->course); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JRMSU E_VOTING SYSTEM\resources\views/admin/voters.blade.php ENDPATH**/ ?>