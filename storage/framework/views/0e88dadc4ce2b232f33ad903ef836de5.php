<?php $__env->startSection('title', 'Voter Login – JRMSU SSG E-Voting'); ?>
...
<form method="POST" action="<?php echo e(route('voter.login.post')); ?>" class="mb-6">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                <label for="student_id" class="block mb-2 text-sm font-medium text-gray-700">Student ID</label>
                <input type="text" id="student_id" name="student_id" required value="<?php echo e(old('student_id')); ?>"
        ...
        <details class="border border-gray-200 rounded-lg">
            ...
            <div class="p-4 border-t border-gray-200">
                <form method="POST" action="<?php echo e(route('voter.register')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JRMSU E_VOTING SYSTEM\resources\views/auth/voter-login.blade.php ENDPATH**/ ?>